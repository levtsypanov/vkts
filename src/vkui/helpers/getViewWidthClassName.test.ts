...
describe('getViewWidthClassName', () => {
  describe('without `styles` argument', () => {
    ...
    it('returns mobile className', () =>
      expect(getViewWidthClassName('base', ViewWidth.MOBILE)).toBe(`base--viewWidth-mobile`));
  ...
  describe('with `styles` argument', () => {
    ...
    it('returns desktop className', () =>
      expect(getViewWidthClassName('base', ViewWidth.DESKTOP, styles)).toContain(
        styles[`base--viewWidth-desktop`],
      ));
    it('returns desktop className', () =>
      expect(getViewWidthClassName('base', ViewWidth.DESKTOP, styles)).toContain(
    ...
    it('returns smallTablet className', () =>
      expect(getViewWidthClassName('base', ViewWidth.SMALL_TABLET, styles)).toContain(
        styles[`base--viewWidth-smallTablet`],
      ));
    it('returns smallTablet className', () =>
      expect(getViewWidthClassName('base', ViewWidth.SMALL_TABLET, styles)).toContain(
        styles[`base--viewWidth-smallTabletPlus`],
    ...
    it('returns smallMobile className', () =>
      expect(getViewWidthClassName('base', ViewWidth.SMALL_MOBILE, styles)).toBe(
        styles[`base--viewWidth-smallMobile`],
      ));
  });
});
