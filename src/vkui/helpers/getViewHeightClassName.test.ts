...
describe('getViewHeightClassName', () => {
  describe('without `styles` argument', () => {
    ...
    it('returns mobile className', () =>
      expect(getViewHeightClassName('base', ViewHeight.MEDIUM)).toBe(`base--viewHeight-medium`));
    it('returns smallMobile className', () =>
      expect(getViewHeightClassName('base', ViewHeight.SMALL)).toBe(`base--viewHeight-small`));
  });
  ...
  describe('with `styles` argument', () => {
    ...
    it('returns desktop className', () =>
      expect(getViewHeightClassName('base', ViewHeight.EXTRA_SMALL, styles)).toBe(
        styles[`base--viewHeight-extraSmall`],
      ));
    it('returns mobile className', () =>
